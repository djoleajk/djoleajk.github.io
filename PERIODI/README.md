...
- `demo-data.js` - Demo podaci za testiranje

## 🎮 Demo Podaci

Za testiranje aplikacije možete koristiti demo podatke:

1. Otvorite **Browser Developer Tools** (F12)
2. Idite na **Console** tab
3. Kopirajte i nalepite: `loadDemoData()`
4. Pritisnite **Enter**
5. **Osvežite stranicu** (F5)

Ovo će učitati primer ciklusa i simptoma za demonstraciju funkcionalnosti.

Za brisanje demo podataka koristite: `clearAllData()`
